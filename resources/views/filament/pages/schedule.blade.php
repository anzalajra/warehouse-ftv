...
<x-filament-panels::page>
    <style>
        ...
        .gr-dd-item.on { background:var(--primary-50); color:var(--primary-700); font-weight:700; }
        .dark .gr-dd-item.on { background:color-mix(in srgb, var(--primary-500) 15%, transparent); color:var(--primary-300); }
        .gr-new { display:inline-flex; align-items:center; gap:5px; padding:8px 16px; border-radius:8px; background:var(--primary-600); color:#fff; border:none; font-size:12px; font-weight:700; cursor:pointer; font-family:inherit; text-decoration:none; }
        .gr-new:hover { background:var(--primary-700); }
        ...
        .gr-day-cell.today { background:color-mix(in srgb, var(--primary-500) 14%, transparent); box-shadow:inset 0 2px 0 0 var(--primary-500); }
        .dark .gr-day-cell.today { background:color-mix(in srgb, var(--primary-500) 22%, transparent); box-shadow:inset 0 2px 0 0 var(--primary-400); }
        ...
        .gr-date-num.today { color:var(--primary-700); font-weight:800; }
        .dark .gr-date-num.today { color:var(--primary-300); }
        .gr-date-num.other { color:#d1d5db; }
        .gr-more-btn { position:absolute; border:none; background:transparent; font-size:10px; color:var(--primary-600); font-weight:700; cursor:pointer; padding:1px 3px; border-radius:4px; font-family:inherit; display:flex; align-items:center; gap:2px; text-decoration:none; }
        .gr-more-btn:hover { background:var(--primary-50); }
        .dark .gr-more-btn { color:var(--primary-300); }
        .dark .gr-more-btn:hover { background:color-mix(in srgb, var(--primary-500) 15%, transparent); }
        ...
        .gr-gantt-day.today { background:var(--primary-50); }
        .dark .gr-gantt-day.today { background:color-mix(in srgb, var(--primary-500) 12%, transparent); }
        ...
        .gr-gantt-date.today { color:var(--primary-600); font-weight:800; }
        .dark .gr-gantt-date.today { color:var(--primary-300); }
        ...
        .gr-gantt-area-cell.today { background:color-mix(in srgb, var(--primary-500) 8%, transparent); }
        .dark .gr-gantt-area-cell.today { background:color-mix(in srgb, var(--primary-500) 10%, transparent); }
        ...
        .gr-day-ws-date.on { background:var(--primary-600); color:#fff; font-weight:700; }
        .gr-day-ws-date.today { background:var(--primary-50); color:var(--primary-700); }
        .dark .gr-day-ws-date.today { background:color-mix(in srgb, var(--primary-500) 15%, transparent); color:var(--primary-300); }
        .gr-day-heading { padding:8px 14px 6px; border-bottom:1px solid #f3f4f6; }
        .dark .gr-day-heading { border-color:rgba(255,255,255,.06); }
        .gr-day-heading-eyebrow { font-size:11px; color:var(--primary-600); font-weight:700; text-transform:uppercase; letter-spacing:.4px; }
        .dark .gr-day-heading-eyebrow { color:var(--primary-300); }
        ...
        .gr-prod-month { flex-shrink:0; padding:6px 0 6px 10px; border-right:1px solid #f3f4f6; font-size:11px; font-weight:800; color:var(--primary-700); letter-spacing:.3px; text-transform:uppercase; }
        .dark .gr-prod-month { color:var(--primary-300); border-color:rgba(255,255,255,.06); }
        ...
        .gr-prod-daycell-head.today { background:var(--primary-50); }
        .dark .gr-prod-daycell-head.today { background:color-mix(in srgb, var(--primary-500) 12%, transparent); }
        ...
        .gr-prod-daycell-num.today { background:var(--primary-600); color:#fff; font-weight:700; }
        ...
        .gr-prod-productcell.today { background:color-mix(in srgb, var(--primary-500) 8%, transparent); }
        ...
        .gr-prod-unitcell.today { background:color-mix(in srgb, var(--primary-500) 8%, transparent); }
                    ...
                    <div class="gr-dd-menu" :class="{ open: ddOpen }">
                        @foreach(['month','week','day'] as $v)
                            <button type="button" class="gr-dd-item {{ $view_mode === $v ? 'on' : '' }}"
                                ...
                                @click="ddOpen=false">
                                @if($view_mode === $v)
                                    <span style="width:6px;height:6px;border-radius:999px;background:var(--primary-600);"></span>
                                @endif
                                {{ ucfirst($v) }}
                            </button>
                        @endforeach
