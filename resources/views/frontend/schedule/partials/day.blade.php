@php
    ...
    $weekDays = $dayData['weekDays'];
    $anchorCarbon = $dayData['anchor'];
    ...
    $showNow = $anchorCarbon->isSameDay($today) && $nowHour >= $START_HOUR && $nowHour <= $END_HOUR;
@endphp
...
<div class="gr-toolbar">
    ...
    <div class="gr-label">{{ $anchorCarbon->format('F Y') }}</div>
</div>
...
<div class="gr-day-weekstrip">
    @foreach($weekDays as $d)
        @php
            $isSelected = $d->isSameDay($anchorCarbon);
            $isToday = $d->isSameDay($today);
        @endphp
        <a href="{{ $buildUrl(['anchor' => $d->toDateString()]) }}" class="gr-day-ws-btn">
...
<div class="gr-day-heading">
    <div class="gr-day-heading-eyebrow">
        {{ $anchorCarbon->isSameDay($today) ? 'Today' : $anchorCarbon->format('l') }}
    </div>
    <div class="gr-day-heading-title">{{ $anchorCarbon->format('l, j F') }}</div>
</div>
